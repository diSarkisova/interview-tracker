...
- [Pinia](https://pinia.vuejs.org/) — состояние и логика
- [Vue Router](https://router.vuejs.org/) — навигация между вкладками
- [Tailwind CSS v4](https://tailwindcss.com/) — стили
- [Supabase](https://supabase.com/) — хранение данных
...
[WebStorm](https://www.jetbrains.com/webstorm/) или [VS Code](https://code.visualstudio.com/) + расширение [Vue (Official)](https://marketplace.visualstudio.com/items?itemName=Vue.volar).
